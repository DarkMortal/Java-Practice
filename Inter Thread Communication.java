    ...
    public synchronized String take(){
        while(empty){
            try{
                ...
                if(empty) return "";  // if no message is received in 4 seconds, return empty string
...
class Producer extends Thread{
    ...
    public Producer(sharedObjectChannel channel_, String tname_){
        super(tname_); this.channel = channel_;
    }
...
class Consumer extends Thread{
    ...
    public void run(){
        ...
        while(true){
            ...
            if(message.isEmpty()){
                System.out.println("No message received, terminating thread: " + Thread.currentThread().getName()); break;
            }
